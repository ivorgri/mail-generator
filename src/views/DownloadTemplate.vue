<template>
  <base-main>
    ...
    <elements :renderInView="false" ref="emailContent"/>
    <form>
      <vue-form-generator
        :schema="schema"
        :model="model"
...
export default {
  ...
  mounted() {
    ...
    this.$nextTick(() => {
      console.log(this.$refs.emailContent);
      console.log(this.$refs.downloadTemplateButton);
      console.log('test');
      console.log(document.getElementById('email-content').innerHTML);
    });

    // Get the HTML of the generated elements component
    // const htmlBody = emailBegin + document.getElementById('email-content').innerHTML + emailEnd;
    // const htmlBody = emailBegin + emailEnd;
    // console.log(htmlBody);
    // const htmlObjectUrl = new Blob([htmlBody], { type: 'text/html' });
