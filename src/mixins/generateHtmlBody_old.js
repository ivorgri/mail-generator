      ...
      let htmlBody = `
        ...
        htmlBody = `
                                ...
                                <tr>
                                    <td style="padding: 0 20px 20px;">
                                        ...
                                        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin: auto;">
                                            <tr>
                                                <td class="button-td button-td-primary" style="border-radius: 4px; background: ${this.template.backgroundColor};">
                              <a class="button-a button-a-primary" href="https://google.com/" style="background: ${this.template.backgroundColor}; border: 1px solid #000000; font-family: sans-serif; font-size: 15px; line-height: 15px; text-decoration: none; padding: 13px 17px; color: #ffffff; display: block; border-radius: 4px;">Centered Primary Button</a>
                            </td>
                                            </tr>
                                        </table>
                                        <!-- Button : END -->
                    ...
                    <tr>
                        ...
                        <td valign="middle" style="text-align: center; background-image: url('http://placehold.it/600x230/222222/666666'); background-color: ${this.template.backgroundColor}; background-position: center center !important; background-size: cover !important;">
                          <!--[if gte mso 9]>
                          <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width:600px;height:175px; background-position: center center !important;">
                          <v:fill type="tile" src="http://placehold.it/600x230/222222/666666" color="${this.template.backgroundColor}" />
                                          ...
                                          <tr>
                                              <td dir="ltr" valign="top" style="font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555; padding: 10px; text-align: left;" class="center-on-narrow">
                                                  ...
                                                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" class="center-on-narrow" style="float:left;">
                                                      <tr>
                                                        <td class="button-td button-td-primary" style="border-radius: 4px; background: ${this.template.backgroundColor};">
                                    <a class="button-a button-a-primary" href="https://google.com/" style="background: ${this.template.backgroundColor}; border: 1px solid #000000; font-family: sans-serif; font-size: 15px; line-height: 15px; text-decoration: none; padding: 13px 17px; color: #ffffff; display: block; border-radius: 4px;">Primary Button</a>
                                  </td>
                                                    </tr>
                                                </table>
                                                <!-- Button : END -->
...
export { generateHtmlBody as default };
